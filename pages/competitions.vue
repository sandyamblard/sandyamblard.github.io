    ...
    <main>
        <section class='contenu' aria-label='Expériences et formations'>
            ...
            <div class='contenu-item'>
              <p class="subtitle">
                Sportive et compétitrice depuis l'enfance, j'ai le goût pour le dépassement de soi et le challenge.
                <br>Après une excellent scolarité en sports-études, je sais m'organiser pour optimiser mon temps et mes compétences.
              </p>
                <h2>Expériences</h2>
...
export default {
    ...
    data(){
        return{
            ...
            competences:['Sports-études', 'Gestion des émotions', "Optimisation de l'entrainement", 'Clicker-training', 'Agility', 'Troupeau', 'Dogdancing', 'CaniVTT', 'Cavage', 'Escalade', "Gymnastique", ]
        ,sportscanins:{   img:'/sportscanins.jpg' ,
                    ...
                    perfs:['Scolarité en horaires aménagés (sports-études)', "Participation aux championnats régionaux", 'Participation aux championnats de France', 'Plusieurs podiums sur concours départementaux et régionaux'],
            }
        }
    }
}
