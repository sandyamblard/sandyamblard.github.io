    ...
    <main>
        <section class='contenu'>
            ...
            <div class='contenu-item'>
                ...
                <ul class='formations'> 
                    <li class="form__item"><span>Depuis 2008 : <span class="bold">Nombreux stages de sports canins </span>, toutes disciplines (agility, dogdancing, troupeau, caniVTT, cavage)</span>, avec intervenants spécialistes, français et étrangers (USA, Hollande, Belgique...)<br>
                    </li>
...
export default {
    ...
    data(){
        return{
            ...
            competences:['Education canine', 'Clicker-training', 'Agility', 'Troupeau', 'Dogdancing', 'CaniVTT', 'Endurance','Escalade', "Gymnastique", 'Sports-études']
        ,sportscanins:{   img:'/sportscanins.jpg' ,
                    ...
                    perfs:['Equipe de France de Dogdancing 2019', 'Participation aux championnats du monde de Dogdancing 2019 en HTM et Freestyle, classée 15ème en HTM', "Championne régionale d'agility", "3 fois Vice-Championne régionale d'agility", "Vainqueur de la coupe régionale d'agility", "Plusieurs sélections pour le Grand Prix de France en agility et Dogdancing", "Sélections pour le championnat de France d'agility", "Vainqueur du Grand Prix de France de Dogdancing, catégorie HTM novice", "2ème Grand Prix de France de Dogdancing, catégorie HTM intermédiaire", "2ème Grand Prix de France de Dogdancing, catégorie HTM avncé", "2ème Grand Prix de France de Dogdancing, catégorie Freestyle intermédiaire", "4ème au classement annuel du challenge régional du caniVTT, catégorie Senior Femme", "Nombreux podiums en concours locaux"],  
            }, escalade:{   img:'' ,
                    title: "Escalade", 
                    ...
                    perfs:["Membre de l'équipe départementale jeune pendant 2ans", 'Participation aux championnats de France de difficulté', 'Participation à des opens internationaux'],  
            }, gym:{   img:'' ,
                    title: "Gymnastique", 
                    ...
                    perfs:['Scolarité en horaires aménagés (sports-études)', "Participation aux championnats régionaux", 'Participation aux championnats de France'],  
            }
        }
    }
}
